...
class GroupHelper:
    ...
    def delete_random_group(self, index):
        wd = self.app.wd
        self.open_groups_page()
        groups = wd.find_elements_by_css_selector(".group")
        groups[index].click()
        wd.find_element_by_name("delete").click()
        self.return_to_groups_page()

    def modify_first_group(self, group):
        self.modify_random_group(group, 0)

    def modify_random_group(self, group, index):
        wd = self.app.wd
        self.open_groups_page()
        groups = wd.find_elements_by_css_selector(".group")
        groups[index].click()
    ...
    def get_group_list(self):
        ...
        for element in wd.find_elements_by_css_selector("span.group"):
            ...
            groups.append(Group(name=text, gid=gid))
        return groups
